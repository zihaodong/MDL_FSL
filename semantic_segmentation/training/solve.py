...
import numpy as np
import sys
caffe_root = 'the path of caffe source code, please replace this line!' 
...
base_weights = 'snapshots/os_pretrained.caffemodel'

# init
caffe.set_mode_gpu()
caffe.set_device(0)

solver = caffe.SGDSolver('solver_ss_os_fc.prototxt')

# do net surgery to set the deconvolution weights for bilinear interpolation
#interp_layers = [k for k in solver.net.params.keys() if 'up' in k]
#interp_surgery(solver.net, interp_layers)
#solver.restore('snapshots/MSDF_iter_4000.solverstate')
